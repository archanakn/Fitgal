...
i0bvals = (1500.0,1000.,5000.,0.1)
revals= (12.,10.,30.0,.1)
ebvals= (0.2,.1,.8,0.01)
nvals=  (4.0,1.,6.1,0.1)
i0dvals= (1500,500,2000.0,0.1)
rdvals= (6.0,1.0,8.0,0.1)
edvals= (0.7,0.1,0.8,0.01)
pointvals= (0.0,-1000.0,10000.0,10.0)
bpavals= (30.0,20,60,.1)
dpavals= (70.0,0.0,90.0,0.1)
backgroundvals= (0.0,-100.0,2000.0,0.1)
...
imagefile = 'test_bulge.fits' # The full path to your galaxy FITS file
